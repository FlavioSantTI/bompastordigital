...
|--------|----------|----------|
| **7.2** | **24/09/2026** | **Refatoração da Lista de Presença**: Conversão do relatório de "Lista por Diocese" para "Relação Geral em Retrato". Removido o agrupamento por diocese, adicionado o campo "Data: ____ / ____ / ________" no cabeçalho. Tabela ajustada para: Sequência (14%), Nome (46%) e Assinatura (40%). Limpeza de rótulos nos cards e modais para "Lista de Presença". |
...
© 2026 Bom Pastor Digital • **Versão 7.2**
